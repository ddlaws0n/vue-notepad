<template>
  <main
    ...
    <button
      class="w-1/2 text-center text-gray-600 py-2 border-b-2 border-transparent focus:outline-none dark:text-white/80"
    ...
    <div
      ...
      <div class="p-4 sm:p-7">
        <div class="text-center">
          <h1 class="block text-2xl font-bold text-gray-800 dark:text-white">{{ formTitle }}</h1>
          ...
          <form>
            <div class="grid gap-y-4">
              ...
              <div
                ...
                <div class="flex">
                  <input
                    v-model="credentials.acceptConditions"
                    id="remember-me"
                    name="remember-me"
                    type="checkbox"
